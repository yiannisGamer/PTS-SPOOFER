...
async def apply(ctx):
    ...
    view.add_item(discord.ui.Button(label="Mod", emoji="https://cdn.discordapp.com/emojis/1289023450953945109.webp?size=96", url="https://forms.gle/UK7n8DQ9PtJ2t8ia8"))
